...
public class FixedStringReplacer implements StringReplacer {
        private Pattern pattern;
        private String replacement;

        public FixedStringReplacer(String from, String to) {
                pattern = Pattern.compile(Pattern.quote(from));
                replacement = to;
        }
        ...
        public Object getReplacement(Matcher matcher) {
                return new StringFilter.Constant(replacement);
        }
}
